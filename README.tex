...
However, the complete HPC cluster setup, configuration, testing,
debugging, and validation were performed manually on a real working
cluster environment.

Every major component documented in this guide was configured and tested
...
\item scheduler-aware MPI jobs
\end{itemize}

All commands, workflows, scripts, and execution procedures were tested
successfully from start to end.
...
\begin{itemize}
\item Linux cluster administration
...
The primary goal of this documentation is not only to provide commands,
but also to explain the concepts behind real HPC environments in a
simple, practical, and beginner-friendly manner.

The setup presented here follows real-world HPC center practices while
remaining accessible for learning, experimentation, and self-study.
\section{Introduction}
\label{sec:org336f2d4}
...
\label{sec:orgac5a6aa}
\subsection{Node Role}
\label{sec:org9bad384}
\begin{enumerate}
\item Master Node
\label{sec:orgd77f7af}
...
\label{sec:org871d0f6}
Open VirtualBox and create a new virtual machine.
\begin{enumerate}
\item VM Name
\label{sec:org689f699}

\begin{verbatim}
master
\end{verbatim}
\item Type
\label{sec:orge0455bd}
...
\label{sec:org79bcf8d}

\begin{enumerate}
\item Adapter 1
\label{sec:org0c847c4}
...
\label{sec:org1ad7e2d}
\begin{enumerate}
\item Check Interfaces
\label{sec:orgc478e2c}
...
\label{sec:org93f9d84}
\begin{enumerate}
\item Check Device Names
\label{sec:org0191ab3}
...
\label{sec:org035a90a}

\begin{verbatim}
sudo systemctl restart NetworkManager
\end{verbatim}
\subsection{Verify Networking}
\label{sec:org746bba0}
...
\label{sec:org7aac554}
\begin{enumerate}
\item Update System
\label{sec:orgbaa317b}

\begin{verbatim}
sudo dnf update -y
\end{verbatim}
\item Install Base Packages
\label{sec:orgfb94766}
...
\label{sec:org5c8ceae}

\begin{enumerate}
\item Login Node
\label{sec:org0580410}
...
\label{sec:orgf47d11f}

\begin{enumerate}
\item Login Node
\label{sec:orgd47f907}
...
\begin{enumerate}
\item Login Node
\label{sec:orga297790}

\begin{verbatim}
10.10.10.2/24
\end{verbatim}
\item Compute01
\label{sec:org1e6ec75}

\begin{verbatim}
10.10.10.11/24
\end{verbatim}
\item Compute02
\label{sec:org3f24430}

\begin{verbatim}
10.10.10.12/24
\end{verbatim}
\item Compute03
\label{sec:orgcafe311}
...
\end{enumerate}
\subsection{Restart Networking}
\label{sec:org2d009dc}

\begin{verbatim}
sudo systemctl restart NetworkManager
\end{verbatim}
\subsection{Verify Networking}
\label{sec:orgc88af87}

\begin{verbatim}
ip addr
\end{verbatim}
\subsection{Verify Routing}
\label{sec:orgaaa7811}
...
\label{sec:org02626d0}

\begin{enumerate}
\item Ping Between Nodes
\label{sec:org28efc86}
...
\label{sec:org9ed8145}

From host:
\begin{enumerate}
\item Master
\label{sec:orga28423e}

\begin{verbatim}
ssh -p 2221 hpcadmin@localhost
\end{verbatim}
\item Login
\label{sec:orgfb6e58d}

\begin{verbatim}
ssh -p 2222 hpcadmin@localhost
\end{verbatim}
\item Compute01
\label{sec:org1f9a479}

\begin{verbatim}
ssh -p 2223 hpcadmin@localhost
\end{verbatim}
\item Compute02
\label{sec:orgd81c075}

\begin{verbatim}
ssh -p 2224 hpcadmin@localhost
\end{verbatim}
\item Compute03
\label{sec:org49dbb6d}
...
\label{sec:org2917e0a}

\begin{enumerate}
\item Master Node
\label{sec:org0a27785}
...
\label{sec:org2d30546}

\begin{enumerate}
\item Master
\label{sec:orgd6c35e8}

\begin{verbatim}
ssh-copy-id hpcadmin@master
\end{verbatim}
\item Compute01
\label{sec:org356488f}

\begin{verbatim}
ssh-copy-id hpcadmin@compute01
\end{verbatim}
\item Compute02
\label{sec:orgeb0b8ad}

\begin{verbatim}
ssh-copy-id hpcadmin@compute02
\end{verbatim}
\item Compute03
\label{sec:org115058f}
...
\label{sec:org13f21f8}

\begin{enumerate}
\item Test Master
\label{sec:orgc1defd1}
...
\end{verbatim}
\item Test Compute02
\label{sec:org161c91d}

\begin{verbatim}
ssh compute02 hostname
\end{verbatim}
\item Test Compute03
\label{sec:org273dcee}
...
\label{sec:org2580ea6}

SSH into master node.
\subsection{Enable NFS Services}
\label{sec:org802857f}
...
\label{sec:org852fc96}

\begin{verbatim}
sudo exportfs -rav
\end{verbatim}
\subsection{Verify Exports}
\label{sec:org2a8dd86}
...
\label{sec:orgb9a1e8d}

\begin{enumerate}
\item Reboot Master First
\label{sec:org6dafbf5}
...
\label{sec:orgf0a4c65}

\begin{verbatim}
sudo reboot
\end{verbatim}
\item Reboot Compute Nodes
\label{sec:org807aeab}
...
\label{sec:org7d2af35}

\begin{enumerate}
\item Master Node
\label{sec:orgab9a308}
...
\label{sec:orgfc0d30d}

\begin{enumerate}
\item Verify Munge
\label{sec:orgd33e219}
...
\label{sec:org5e3cc28}

\begin{enumerate}
\item Verify Munge User
\label{sec:org52fbcee}

\begin{verbatim}
id munge
\end{verbatim}
\item Verify Slurm User
\label{sec:org4f2c00b}
...
\label{sec:org474bbb3}

\begin{verbatim}
sudo groupadd slurm
\end{verbatim}
\subsection{Create Slurm User}
\label{sec:org1f68acf}
...
\label{sec:orga9c0deb}

\begin{enumerate}
\item Copy Key Temporarily
\label{sec:org3d73738}
...
\label{sec:orge52ab2c}

\begin{enumerate}
\item On Master
\label{sec:org19d0202}
...
\label{sec:orga8a9abd}

\begin{enumerate}
\item Single Node Test
\label{sec:org01bd216}
...
\label{sec:orgfc66da2}

\begin{verbatim}
sudo mkdir -p /apps
\end{verbatim}
\subsection{Get Filesystem UUID}
\label{sec:org5246634}
...
\label{sec:orgdd5f51e}

\begin{verbatim}
sudo mount -a
\end{verbatim}
\subsection{Verify Mount}
\label{sec:org019db74}
...
\label{sec:orgd9b9b02}

\begin{verbatim}
sudo exportfs -rav
\end{verbatim}
\subsection{Verify Exports}
\label{sec:org0d4fa63}
...
\label{sec:org97ef1bc}

\begin{verbatim}
sudo mount -a
\end{verbatim}
\subsection{Verify Shared Mount}
\label{sec:org0fd0b30}
